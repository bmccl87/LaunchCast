...
def create_parser():
    ...
    parser.add_argument('--focal',action='store_true',default=False,help='Flag to use the focal cross entropy')
    parser.add_argument('--from_logits',action='store_true',default=False,help='Flag to use logits')
    parser.add_argument('--cc_bias',type=float,default=-2.5)
    parser.add_argument('--cg_bias',type=float,default=-2.5)
    ...
    parser.add_argument('--efm_dist_encoder_deep',type=int,default=3)
    parser.add_argument('--efm_dist_encoder_filters',nargs=5,type=int,default=[32,64,128,256,512])
    ...
    parser.add_argument('--LC_decoder_channels',nargs=5,type=int,default=[512,256,128,64,32])

    #HRRR_arguments
    parser.add_argument('--HRRR_input_shape',nargs=3,type=int,default=[64,64,1])
